...
function App() {
    ...
    const fileInputRef = useRef<HTMLInputElement>(null); // Define fileInputRef
    ...
    const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (event.target.files && event.target.files.length > 0) {
            ...
            const lowerCaseFileName = selectedFile.name.toLowerCase(); // Check lowercase
            // Updated file type check
            if (lowerCaseFileName.endsWith('.csv') || lowerCaseFileName.endsWith('.xlsx') || lowerCaseFileName.endsWith('.pdf') ||
                lowerCaseFileName.endsWith('.png') || lowerCaseFileName.endsWith('.jpg') || lowerCaseFileName.endsWith('.jpeg') ||
                lowerCaseFileName.endsWith('.gif') || lowerCaseFileName.endsWith('.webp')) {
                ...
                setError('Unsupported file type. Please upload CSV, XLSX, PDF, PNG, JPG, GIF, or WEBP.');
    ...
    const handleHelpContextFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        if (event.target.files && event.target.files.length > 0) {
            ...
            if (lowerCaseFileName.endsWith('.csv') || lowerCaseFileName.endsWith('.xlsx') || lowerCaseFileName.endsWith('.pdf') ||
                ...
                alert('Unsupported file type. Please upload CSV, XLSX, PDF, PNG, JPG, GIF, or WEBP.');
            }
        } else {
            setHelpContextFile(null);
            setHelpContextFileName(null);
            ...
            <img src={audacyLogo} alt="Audacy Logo" className="audacy-logo" />
                        ...
                        <div className="app-instructions">
                            ...
                            <span className="instruction-step">
                                ...
                                <strong>Upload:</strong> Add the campaign data file (CSV, XLSX, PDF, Images).
                            </span>
                            <span className="instruction-step">
            ...
            <div className="text-area-container">
                ...
                />
                        ...
                        <input
                                type="file"
                                id="file-upload"
                                accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel, application/pdf, image/png, image/jpeg, image/gif, image/webp" // Added image types
                            ...
                            {!file && !fileName && (
                                <p className="file-name prompt-text">Please select a CSV, XLSX, PDF, PNG, JPG, GIF, or WEBP file.</p>
                            )}
            </div>
                                              ...
                                              <div className="history-entry">
                                                  <div className="history-entry-header" style={{
                                                      ...
                                                      <div className="history-entry-info">
                                                          ...
                                                          {/* Meta tags remain stacked below */}
                                                          ...
                                                          {/* Filename remains stacked below */}
                                                      ...
                                                      {/* Action buttons container remains the same */}
                                                      <div style={{
                                                          display: 'flex',
                                                          flexDirection: 'row',
                                                          alignItems: 'center',
